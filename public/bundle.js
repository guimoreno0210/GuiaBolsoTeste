...
var Home = function (_React$Component) {
    ...
    _createClass(Home, [{
        ...
        value: function componentDidMount() {
            ...
            _axios2.default.get('https://api.chucknorris.io/jokes/categories').then(function (response) {
        ...
        value: function handleClick(e) {
            ...
            var getCategory = e.target.getAttribute('data-id');

            _axios2.default.get('https://api.chucknorris.io/jokes/random?category=' + getCategory).then(function (response) {
                _this3.setState({
        ...
        value: function render() {
            ...
            var showContent = _react2.default.createElement(
                'div',
                { className: 'col-xs-8 col-sm-6 col-md-12 pull-right' },
                _react2.default.createElement(
                    'div',
                    { className: 'controller' },
                    _react2.default.createElement('img', { src: this.state.icon_url }),
                    _react2.default.createElement(
                        'blockquote',
                        null,
                        _react2.default.createElement(
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'col-xs-4 col-sm-6 col-md-12 pull-left' },
                    _react2.default.createElement(
                        'ul',
                        null,
                        this.state.category.map(function (item, idx) {
                            return _react2.default.createElement(
                                'li',
                                { key: idx, 'data-id': item, onClick: _this4.handleClick },
                                item
                            );
                        })
                    )
